			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown"><a
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="loct">Location</a></li>
						<li><a class="dropdown-item" href="ContactLog">Call Logs</a></li>
						<li><a class="dropdown-item" href="hist">Browsing History</a></li>
					</ul></li>
