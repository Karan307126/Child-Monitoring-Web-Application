<%@page import="childcms.Database.*"%>
<%@page import="childcms.Servlet.*"%>
<%@page import="childcms.Child.*"%>
<%@page import="childcms.Dao.*"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>

<%
Child auth = (Child) request.getSession().getAttribute("auth");
if (auth != null) {
					...
					<form action="Signup" method="post">
						...
						<div class="mb-3">
							...
							<input type="password" class="form-control"
								...
								for="cexampleInputPassword1" class="form-label">Confirm
